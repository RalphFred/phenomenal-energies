    ...
    <section className="bg-white rounded-2xl py-12 px-4 lg:px-8">
      <div className="">        
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
          ...
          <p className="mb-6">
            Our team of certified professionals brings decades of combined experience in oil, gas, 
            and energy operations. We understand the unique challenges faced by energy companies 
            and provide tailored solutions that ensure operational excellence, regulatory compliance, 
